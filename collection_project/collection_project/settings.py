"""
Django settings for collection_project project.
...
ROOT_URLCONF = 'collection_project.urls'
...
WSGI_APPLICATION = 'collection_project.wsgi.application'
...
# Static files collected path (for collectstatic)
